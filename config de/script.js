...
`;
  ...
  const parquetOption = (
    ...
    <div class="checkbox-container">
        ...
        <label for="${inputValue}" class="checkbox-label">
            <img src="${checkboxImage || ""}" alt="Icon für ${displayName}" class="checkbox-image" loading="lazy" onerror="this.onerror=null; this.src='';">
        </label>
    </div>`;
  };
  ...
  function generateNewDetailedMaterialModalContent(houseTypeKey) {
    ...
    let html = `<img src="${houseData.image}" alt="${houseData.name}" style="width:100%; max-height: 400px; object-fit: cover; margin-bottom: 20px; border-radius: 4px;" loading="lazy" onerror="this.onerror=null; this.src='';">`;
      ...
      switch (tabId) {
        ...
        case "step-2":
          ...
          modalContentProvider = () => {
            ...
            let modalHtml = `<img src="${floorplanDataForModal.image}" alt="Grundriss ${floorplanDataForModal.name}" style="width:100%; max-height: 400px; object-fit: contain; margin-bottom: 20px; border-radius: 4px;" loading="lazy" onerror="this.onerror=null; this.src='';">`;
