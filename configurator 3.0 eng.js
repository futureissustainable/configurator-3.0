(function() {
    ...
    let config = {
        'nomad-24' : {
            ...
            "name": "Nomad", "energy": 34920, "basePriceText": "From €39,800",
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semi-finished', "price" : 39800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4339236794245a361e6b9_742d4a56b01c157fcfb78d250a5c284b_24m2%20Nomad%204.1.avif',
                    'images': [
                        { 'src' : 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f0499f53b61b42090_24m2%20Nomad%20OSB%204.0.avif', 'alt' : 'Nomad Semi-finished Top'},
                        { 'src' : 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4339236794245a361e6b9_742d4a56b01c157fcfb78d250a5c284b_24m2%20Nomad%204.1.avif', 'alt' : 'Nomad Semi-finished Bottom'}
                    ],
                    'upgrades' : [
                        [ { 'slug' : "parquet-raw-osb", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f0499f53b61b42090_24m2%20Nomad%20OSB%204.0.avif", 'icon' : osbIconUrl, 'price': 0, 'included': true, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4388b838ef609a824c885_24m2%20Nomad%20OSB%20%2B%20Cashmere%204.0.avif", 'price': 1800, 'included': false, 'name': "Cashmere Parquet", 'icon' : cashmereIconUrl},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4388ba91d0f79d44ce0d2_24m2%20Nomad%20OSB%20%2B%20Hazelnut%204.0.avif", 'price': 1800, 'included': false, 'name': "Hazelnut Parquet", 'icon' : hazelnutIconUrl} ],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283757ec629f34a599c8_24m2%20Nomad%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [ { 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 4800, 'included': false, 'name': "Ventilation System + Ducting"} ],
                        [ { 'slug' : "blinds", 'image': blindsImage, 'price': 2000, 'included': false, 'name': "Smart Blinds"} ] ]
                },
                { 'slug': 'turnkey', 'name': 'Turnkey', "price" : 59800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4339236794245a361e6b9_742d4a56b01c157fcfb78d250a5c284b_24m2%20Nomad%204.1.avif',
                    'images': [
                        { 'src' : 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283437fe5ebcf02aa7ab_24m2%20Nomad%20Interior%204.0.avif', 'alt' : 'Nomad Turnkey Top'},
                        { 'src' : 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4339236794245a361e6b9_742d4a56b01c157fcfb78d250a5c284b_24m2%20Nomad%204.1.avif', 'alt' : 'Nomad Turnkey Bottom'}
                    ],
                    'upgrades' : [
                        [
                            { 'slug' : "parquet-raw-osb", 'image': "", 'price': 0, 'included': true, 'name': "OSB", 'icon' : osbIconUrl},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283437fe5ebcf02aa7ab_24m2%20Nomad%20Interior%204.0.avif", 'price': 0, 'included': true, 'name': "Cashmere Parquet", 'icon' : cashmereIconUrl},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c43ad5d75d99a4806d7d4b_24m2%20Nomad%20Interior%20Hazelnut%204.0.avif", 'price': 0, 'included': false, 'name': "Hazelnut Parquet", 'icon' : hazelnutIconUrl} ],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283757ec629f34a599c8_24m2%20Nomad%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [ { 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 0, 'included': true, 'name': "Ventilation System + Ducting"} ],
                        [ { 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Smart Blinds"} ] ]
                }
            ],
            "floorplan" : [
                { 'slug' : "floorplan-a", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c43d2244f5d6be3af87aab_24m2%20Floorplan%20A.avif", 'price': 0, 'name': 'Plan A', 'modal': "<h3>24m² Plan A</h3><br><p>Interior: 5.70m x 3.10m x 2.50m</p><p>Exterior: 6.40m x 3.80m x 3.20m</p><h4>Rooms</h4><p>Bedroom: 14.20m²</p><p>Bathroom: 2.65m²</p><p>Storage / Kitchenette: 0.80m²</p>" },
                { 'slug' : "floorplan-b", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c43d22e33276e515d43a8f_24m2%20Floorplan%20B.avif", 'price': 0, 'name': 'Plan B', 'modal': "<h3>24m² Plan B</h3><br><p>Interior: 5.70m x 3.10m x 2.50m</p><p>Exterior: 6.40m x 3.80m x 3.20m</p><h4>Rooms</h4><p>Bedroom: 14.20m²</p><p>Bathroom: 2.65m²</p><p>Storage / Kitchenette: 0.80m²</p>" } ] },
        'wanderlust-48' : {
            "image" : "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283782a535d591653c65_48m2%20Wanderlust%204.0.avif",
            "name": "Wanderlust", "energy": 69840, "basePriceText": "From €59,800",
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semi-finished', "price" : 59800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283782a535d591653c65_48m2%20Wanderlust%204.0.avif',
                    'images': [
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834c118eb9aa4496812_48m2%20Wanderlust%20OSB%204.0.avif', 'alt':'Wanderlust Semi-finished Top'},
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283782a535d591653c65_48m2%20Wanderlust%204.0.avif', 'alt':'Wanderlust Semi-finished Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834c118eb9aa4496812_48m2%20Wanderlust%20OSB%204.0.avif", 'price': 0, 'included': true, 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834f6342091f39dfedb_48m2%20Wanderlust%20OSB%20%2B%20Cashmere%204.0.avif", 'price': 3800, 'included': false, 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283416e5d5e698aa09c6_48m2%20Wanderlust%20OSB%20%2B%20Hazelnut%204.0.avif", 'price': 3800, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}], // NOTE: DUPLICATE LINK for Hazelnut
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428347a78da3d6cd218de_48m2%20Wanderlust%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 7800, 'included': false, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 4000, 'included': false, 'name': "Smart Blinds"}] ]
                },
                { 'slug': 'turnkey', 'name': 'Turnkey', "price" : 109800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283782a535d591653c65_48m2%20Wanderlust%204.0.avif',
                    'images': [
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282fadd6a68f7235f463_48m2%20Wanderlust%20Interior%20Cashmere%204.0.avif', 'alt':'Wanderlust Turnkey Top'},
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283782a535d591653c65_48m2%20Wanderlust%204.0.avif', 'alt':'Wanderlust Turnkey Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "", 'price': 0, 'included': true, 'name': "OSB", 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282fadd6a68f7235f463_48m2%20Wanderlust%20Interior%20Cashmere%204.0.avif", 'price': 0, 'included': true, 'name': "Cashmere Parquet", 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f1a20245ff5ca4510_48m2%20Wanderlust%20Interior%20Hazelnut%204.0.avif", 'price': 0, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428347a78da3d6cd218de_48m2%20Wanderlust%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 0, 'included': true, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Smart Blinds"}] ]
            ...
            "floorplan" : [
                { 'slug' : "floorplan-a", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c525733fc3797a1ea68b6_48m2%20Floorplan%20A.png", 'price': 0, 'name': 'Plan A', 'modal': "<h3>48m² Plan A</h3><br><p>Interior: 11.80m x 3.10m x 2.50m</p><p>Exterior: 12.60m x 3.80m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 19.90m²</p><br><p>1. Bedroom: 11.80m²</p><br><p>1. Bathroom: 4.50m²</p>"},
                { 'slug' : "floorplan-b", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514f671a54486d036b53_48m2%20Floorplan%20B.png", 'price': 0, 'name': 'Plan B', 'modal': "<h3>48m² Plan B</h3><br><p>Interior: 11.80m x 3.10m x 2.50m</p><p>Exterior: 12.60m x 3.80m x 3.20m</p><h4>Rooms</h4><p>1. Bedroom: 11.80m²</p><p>2. Bedroom: 11.80m²</p><br><p>1. Bathroom: 4.50m²</p><p>2. Bathroom: 3.50m²</p><p>Hallway: 3.50m²</p>" } ] },
        'serenity-95' : {
            "image" : "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428362a03aef0fc05960f_95m2%20Serenity%204.0.avif",
            "name": "Serenity", "energy": 138225, "basePriceText": "From €109,800",
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semi-finished', "price" : 109800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428362a03aef0fc05960f_95m2%20Serenity%204.0.avif',
                    'images': [
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834cbf67979df378474_95m2%20Serenity%20OSB%204.0.avif', 'alt':'Serenity Semi-finished Top'},
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428362a03aef0fc05960f_95m2%20Serenity%204.0.avif', 'alt':'Serenity Semi-finished Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834cbf67979df378474_95m2%20Serenity%20OSB%204.0.avif", 'price': 0, 'included': true, 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4283456778eb848b0ef0a_95m2%20Serenity%20OSB%20%2B%20Cashmere%204.0.avif", 'price': 7800, 'included': false, 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428364c8e49bed391084c_95m2%20Serenity%20OSB%20%2B%20Hazelnut%204.0.avif", 'price': 7800, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834c7a50abaf20e6a83_95m2%20Serenity%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 9800, 'included': false, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 7000, 'included': false, 'name': "Smart Blinds"}] ]
                },
                { 'slug': 'turnkey', 'name': 'Turnkey', "price" : 189800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428362a03aef0fc05960f_95m2%20Serenity%204.0.avif',
                    'images': [
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f9eb780fb3d07ba0f_95m2%20Serenity%20Cashmere%204.0.avif', 'alt':'Serenity Turnkey Top'},
                        {'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428362a03aef0fc05960f_95m2%20Serenity%204.0.avif', 'alt':'Serenity Turnkey Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "", 'price': 0, 'included': true, 'name': "OSB", 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f9eb780fb3d07ba0f_95m2%20Serenity%20Cashmere%204.0.avif", 'price': 0, 'included': true, 'name': "Cashmere Parquet", 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c4282f8de7c20305542612_95m2%20Serenity%20Hazelnut%204.0.avif", 'price': 0, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42834c7a50abaf20e6a83_95m2%20Serenity%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 0, 'included': true, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Smart Blinds"}] ]
            ...
            "floorplan" : [
                { 'slug' : "floorplan-a", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514e29f50d2da31e84dc_95m2%20Floorplan%20A.png", 'price': 0, 'name': 'Plan A', 'modal': "<h3>95m² Plan A</h3><br><p>Interior: 11.80m x 6.80m x 2.50m</p><p>Exterior: 12.60m x 7.60m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 19.90m²</p><br><p>1. Bedroom: 11.80m²</p><br><p>1. Bathroom: 4.50m²</p>"},
                { 'slug' : "floorplan-b", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514fdf7becede16b71e9_95m2%20Floorplan%20B.png", 'price': 0, 'name': 'Plan B', 'modal': "<h3>95m² Plan B</h3><br><p>Interior: 11.80m x 6.80m x 2.50m</p><p>Exterior: 12.60m x 7.60m x 3.20m</p><h4>Rooms</h4><p>1. Bedroom: 11.80m²</p><p>2. Bedroom: 11.80m²</p><br><p>1. Bathroom: 4.50m²</p><p>2. Bathroom: 3.50m²</p><p>Hallway: 3.50m²</p>"},
                { 'slug' : "floorplan-c", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514ff885d32e87f5d5ef_95m2%20Floorplan%20C.png", 'price': 0, 'name': 'Plan C', 'modal': "<h3>95m² Plan C</h3><br><p>Interior: 11.80m x 6.80m x 2.50m</p><p>Exterior: 12.60m x 7.60m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 53.70m²</p><br><p>1. Bedroom: 13.10m²</p><br><p>1. Bathroom: 3.75m²</p><p>2. Bathroom: 4.35m²</p>"} ] },
        'sanctuary-142' : {
            "image" : "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42836759488180078dc28_142m2%20Sanctuary%204.0.avif",
            "name": "Sanctuary", "energy": 175285, "basePriceText": "From €159,800",
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semi-finished', "price" : 159800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42836759488180078dc28_142m2%20Sanctuary%204.0.avif',
                    'images': [
                        { 'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c440552e93c6b2b6549f82_142m2%20Sanctuary%20OSB%204.0.avif', 'alt':'Sanctuary Semi-finished Top'},
                        { 'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42836759488180078dc28_142m2%20Sanctuary%204.0.avif', 'alt':'Sanctuary Turnkey Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c440552e93c6b2b6549f82_142m2%20Sanctuary%20OSB%204.0.avif", 'price': 0, 'included': true, 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c440551ad361e009f1da6e_142m2%20Sanctuary%20OSB%20%2B%20Cashmere%204.0.avif", 'price': 11800, 'included': false, 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c44055c519f4722b8ef029_142m2%20Sanctuary%20OSB%20%2B%20Hazelnut%204.0.avif", 'price': 11800, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428364c5adf6fa2aec1c1_142m2%20Sanctuary%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 9800, 'included': false, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 9000, 'included': false, 'name': "Smart Blinds"}] ]
                },
                { 'slug': 'turnkey', 'name': 'Turnkey', "price" : 279800,
                    'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42836759488180078dc28_142m2%20Sanctuary%204.0.avif',
                    'images': [
                        { 'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c440551c75cb12af61eff9_142m2%20Sanctuary%20Interior%20Cashmere%204.0.avif', 'alt':'Sanctuary Turnkey Top'},
                        { 'src':'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c42836759488180078dc28_142m2%20Sanctuary%204.0.avif', 'alt':'Sanctuary Turnkey Bottom'}
                    ],
                    'upgrades' : [
                        [{ 'slug' : "parquet-raw-osb", 'image': "", 'price': 0, 'included': true, 'name': "OSB", 'icon' : osbIconUrl, 'name': "OSB"},
                            { 'slug' : "parquet-cashmere", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c440551c75cb12af61eff9_142m2%20Sanctuary%20Interior%20Cashmere%204.0.avif", 'price': 0, 'included': true, 'icon' : cashmereIconUrl, 'name': "Cashmere Parquet"},
                            { 'slug' : "parquet-hazelnut", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c44055256a682dd59e9ad7_142m2%20Sanctuary%20Interior%20Hazelnut%204.0.avif", 'price': 0, 'included': false, 'icon' : hazelnutIconUrl, 'name': "Hazelnut Parquet"}],
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Yakisugi Exterior Facade"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c428364c5adf6fa2aec1c1_142m2%20Sanctuary%20Lunawood%204.0.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Lunawood Exterior Facade"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 0, 'included': true, 'name': "Ventilation System + Ducting"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Smart Blinds"}] ]
            ...
            "floorplan" : [
                { 'slug' : "floorplan-a", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514ff7e14cb1b083351b_142m2%20Floorplan%20A.png", 'price': 0, 'name': 'Plan A', 'modal': "<h3>142m² Plan A</h3><br><p>Interior: 11.80m x 10.60m x 2.50m</p><p>Exterior: 12.60m x 11.30m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 62.90m²</p><br><p>1. Bedroom: 12.40m²</p><p>2. Bedroom: 12.20m²</p><p>3. Bedroom: 12.40m²</p><p>4. Bedroom: 13.10m²</p><br><p>1. Bathroom: 3.75m²</p><p>2. Bathroom: 4.35m²</p>"},
                { 'slug' : "floorplan-b", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514f6966128dbeb27986_142m2%20Floorplan%20B.png", 'price': 0, 'name': 'Plan B', 'modal': "<h3>142m² Plan B</h3><br><p>Interior: 11.80m x 10.60m x 2.50m</p><p>Exterior: 12.60m x 11.30m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 75.30m²</p><br><p>1. Bedroom: 12.20m²</p><p>2. Bedroom: 12.40m²</p><p>3. Bedroom: 13.10m²</p><br><p>1. Bathroom: 3.75m²</p><p>2. Bathroom: 4.35m²</p>"},
                { 'slug' : "floorplan-c", 'image': "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514fd4d57aa8ff3d75e9_142m2%20Floorplan%20C.png", 'price': 0, 'name': 'Plan C', 'modal': "<h3>142m² Plan C</h3><br><p>Interior: 11.80m x 10.60m x 2.50m</p><p>Exterior: 12.60m x 11.30m x 3.20m</p><h4>Rooms</h4><p>Living + Kitchen: 87.50m²</p><br><p>1. Bedroom: 12.40m²</p><p>2. Bedroom: 13.10m²</p><br><p>1. Bathroom: 3.75m²</p><p>2. Bathroom: 4.35m²</p>"} ] }
    };

    const turnkeyMaterialItemsRaw = `
    MODULAR UPGRADE // TITLE
    New Generation<split>MODULAR, now perfected with Passivhaus certified aluminum frames, organic ultra-insulation from wood fiber, an optimized, stronger structure, and an exclusive selection of premium finishes. Designed for comfort, durability, and efficiency at the highest level.
    STRUCTURE // TITLE
    ...
    C24 Timber Frame Structure BIOBUILDS<split>FSC/PEFC certified wood, exceptional load resistance.
    ...
    DWD Board (AGEPAN, Germany)<split>Allows walls to "breathe" while maintaining exterior airtightness; CE certified.
    Intelligent Membrane<split>Ensures interior airtightness with controlled vapor diffusion to the exterior.
    ...
    Ventilated flat roof<split>Superior thermal performance, extended lifespan by preventing moisture accumulation and overheating. The roof has an invisible slope (~5°), waterproofed with a premium membrane, with a minimum 10-year manufacturer warranty.
    ...
    Triple-glazed, laminated glass<split>Exceptional efficiency and safety (U = 0.50 W/m²K), laminated for extra protection.
    KITCHEN // TITLE
    ...
    Electrical installation<split>Complete electrical panel, compliant with strict EU standards. Switches and protections compliant with local norms, including AFDD technology.
    ...
    Fiberglass wallpaper<split>Very high resistance to traction and wear; washable; modern look.
    Triple-layered natural wood parquet<split>Thickness 9–14 mm; FSC/PEFC certified wood; very durable finish.
    Schneider sockets<split>Premium sockets made in Germany; CE/VDE certified.
    INTERIOR DOORS // TITLE
    S10 interior doors<split>CE certified; Solid core.
    COMPLETE BATHROOM FINISHES // TITLE
    Stone composite tiles<split>Premium whole tiles of 2.5 × 1.2 m; 100% waterproof; very high durability over time.
    Italian design washbasin<split>Premium composite material; ultra-thin, modern, and durable.
    ...
    SMART SYSTEMS // TITLE
    Lighting track<split>Flexible configuration for LED and spotlights; modern aesthetic.
    ...
    Passivhaus Certification<split>Issued by the Passive House Institute (Germany), it attests to unprecedented energy efficiency and exceptional comfort. For a permanent home built to the strictest international standards.
    ...
    Standard EU Warranty<split>24 months residential. 12 months commercial. Extended warranty options available upon request.
    Manufacturer Warranties<split>Beneficiaries receive full coverage through warranties offered by individual suppliers.
    DISCLAIMER // TITLE
    ...
    MODULAR UPGRADE // TITLE
    New Generation<split>MODULAR, now perfected with Passivhaus certified aluminum frames, organic ultra-insulation from wood fiber, and an optimized structure. Designed for comfort, durability, and efficiency at the highest level.
    STRUCTURE // TITLE
    The MODULAR Structural System<split>Combines remarkable mechanical strength with unprecedented efficiency, completely eliminating thermal bridges. Certified for energy efficiency by the Passive House Institute (Darmstadt, Germany) at 0.15 W/(m²K) and for sustainability by EPD (International).
    C24 Timber Frame Structure BIOBUILDS<split>FSC/PEFC certified wood, exceptional load resistance.
    STEICO wood fiber insulation<split>Organic, sustainable, and ultra-efficient (λ ≈ 0.036 W/m·K), CE certified.
    ...
    const upgradeRenderConfig = [
        { groupIndex: 0, queryParam: 'SQF_PARQUET', type: 'parquet', defaultName: 'Parquet' },
        { groupIndex: 1, queryParam: 'SQF_FACADE', type: 'parquet', defaultName: 'Facade' },
        { groupIndex: 2, queryParam: 'SQF_VENTILATION', type: 'checkbox', defaultName: 'Ventilation System' },
        { groupIndex: 3, queryParam: 'SQF_BLINDS', type: 'checkbox', defaultName: 'Smart Blinds' }
    ];
    ...
    const parquetOption = (inputType, inputName, price, inputValue, displayName, checkboxImage, isCheckedByDefault) => {
        ...
        <div class="checkbox-container">
            ...
            <label for="${inputValue}" class="checkbox-label">
                <img src="${checkboxImage || ''}" alt="${displayName} Icon" class="checkbox-image" onerror="this.onerror=null; this.src='';">
            </label>
        </div>`;
    };
    ...
    function generateNewDetailedMaterialModalContent(houseTypeKey) {
        ...
        if (!houseData) return "<p>Details unavailable.</p>";

        let modalHtml = `<img src="${houseData.image}" alt="Main image of ${houseData.name}" style="width:100%; max-height: 300px; object-fit: cover; margin-bottom: 20px; border-radius: 4px;" onerror="this.onerror=null; this.src='';">`;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (!houseData) {
            ...
            document.body.innerHTML = "<p style='text-align:center;padding:20px;'>Error: The configuration for the selected model could not be loaded.</p>";
            return;
        }
        ...
        formTabsArray.forEach(tab => {
            ...
            switch (tabId) {
                ...
                case 'step-2':
                    ...
                    buttonText = `See details for plan ${planLetter}`;
                    modalContentProvider = () => {
                        ...
                        if (!floorplanDataForModal) {
                             return "<p>Please select a plan to see the details.</p>";
                        }
    ...
    function setTabTitles() {
        ...
        setTabTitle('Floor Plan', 'step-2', 'floorplanStepTitle');
    ...
    function crossfadeStickyImage(newSrc, isFloorplan = false) {
        ...
        imageToLoad.onerror = function() {
            this.onerror=null;
            console.warn("Error loading image:", newSrc, ". Displaying default image.");
    ...
    function render_floorplan() {
        ...
        if(floorplanDetailsLink){
            ...
            if (floorplanData && floorplanData.name) {
                floorplanDetailsLink.textContent = `See details for plan ${floorplanData.name.replace('Plan ', '')}`;
            } else {
                floorplanDetailsLink.textContent = "See plan details";
            }
        }
    }
    ...
    function render_economy_price(){
        ...
        economyWrapper.forEach(economy => economy.innerHTML = "Est. savings on consumption (50 years): " + savings);
    }
    ...
    function render_price(finalPriceToShow, isDiscounted = false, originalPriceBeforeDiscount = null) {
        ...
        if (!config[type] || !config[type].options || config[type].options.length === 0) {
            priceBoxH4.innerHTML = "Price unavailable <span class='tva-label'> + VAT</span>";
            return;
        }
    ...
    function generateParquetOptions(options, tabID, inputName, append = false, groupDefaultName = "Options"){
        let tab = document.getElementById(tabID);
        if (!tab) return;
        let container = tab.querySelector('.options-container');
        if (!container) return;
        ...
        options.forEach((option) => {
            ...
            if (isDefaultChecked) {
                ...
                if (option.price === 0 && option.included) { firstPriceText = "Included"; }
                else if (option.price === 0) { firstPriceText = "Included"; }
                else { firstPriceText = `${formatCurrency(option.price)} + VAT`; }
            }
        });
         ...
         if (finalContinueBtnRef) {
             finalContinueBtnRef.addEventListener('click', () => {
                 ...
                 if (!queryArgs['SQF_FINISH']) {
                     showNotification(document.getElementById('step-1'), "Please select a finish type.");
                     allValid = false;
                 }

                 if (!queryArgs['SQF_FLOORPLAN']) {
                     showNotification(document.getElementById('step-2'), "Please select a floor plan.");
                     allValid = false;
                 }
                 ...
                 if (upgradeContainer) {
                     ...
                     uniqueVisibleRadioNames.forEach(name => {
                         ...
                         if (isRenderedRadioOrParquet && !queryArgs[name] && !document.querySelector(`input[name="${name}"]:checked`)) {
                             ...
                             showNotification(document.getElementById('step-3'), `Please make a selection for ${groupTitle}.`);
                             allValid = false;
                         }
                     });
                 }
