(function() {
    ...
    const solarImage = "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68e35fa1ebd21311eeb0f8ac_Solar%20Pannels.avif";
    ...
    const solarKits = {
        "nest-24": {
            ...
            phase: 1,
            phaseLabel: "Monofazat",
            stringConfig: "1×8 sau 2×4"
        },
        "wanderlust-48": {
            kWp: 6,
            price: 11800,
            ...
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semifinisat', "price" : 39800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2db5bc300eaac8d8d34_24%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [ { 'slug' : "ventilation-system", 'image': ventilationImage24, 'price': 4800, 'included': false, 'name': "Sistem Ventilație Zehnder"} ],
                        [ { 'slug' : "blinds", 'image': blindsImage, 'price': 2000, 'included': false, 'name': "Jaluzele Smart"} ],
                        [ { 'slug' : "solar-kit", 'image': solarImage, 'price': 7800, 'included': false, 'name': "Kit Solar - Prosumator"} ] ]
                },
                { 'slug': 'turnkey', 'name': 'La cheie', "price" : 59800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2db5bc300eaac8d8d34_24%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [ { 'slug' : "ventilation-system", 'image': ventilationImage24, 'price': 0, 'included': true, 'name': "Sistem Ventilație Zehnder"} ],
                        [ { 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Jaluzele Smart"} ],
                        [ { 'slug' : "solar-kit", 'image': solarImage, 'price': 7800, 'included': false, 'name': "Kit Solar - Prosumator"} ] ]
                }
            ],
            "floorplan" : [
                { slug: "floorplan-a", image: "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c43d2244f5d6be3af87aab_24m2%20Floorplan%20A.avif", price: 0, name: "Plan A · 1 Dormitor", title: "24m² Plan A", rooms: [{ name: "Dormitor", size: "13.26m²" }, { name: "Baie", size: "2.71m²" }], dimensions: { exterior: { L: "6.35m", W: "3.84m", H: "3.30m" }, interior: { L: "5.59m", W: "3.08m", H: "2.50m" } }, totalExterior: "24.38m²", totalInterior: "15.97m²" },
                { slug: "floorplan-b", image: "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/68c43d22e33276e515d43a8f_24m2%20Floorplan%20B.avif", price: 0, name: "Plan B · 1 Dormitor", title: "24m² Plan B", rooms: [{ name: "Dormitor", size: "13.26m²" }, { name: "Baie", size: "2.71m²" }], dimensions: { exterior: { L: "6.35m", W: "3.84m", H: "3.30m" }, interior: { L: "5.59m", W: "3.08m", H: "2.50m" } }, totalExterior: "24.38m²", totalInterior: "15.97m²" }
            ]
        },
        'wanderlust-48' : {
            ...
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semifinisat', "price" : 59800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2de138a2e743e8b46a5_48%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage48, 'price': 7800, 'included': false, 'name': "Sistem Ventilație Zehnder"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 4000, 'included': false, 'name': "Jaluzele Smart"}],
                        [{ 'slug' : "solar-kit", 'image': solarImage, 'price': 11800, 'included': false, 'name': "Kit Solar - Prosumator"}] ]
                },
                { 'slug': 'turnkey', 'name': 'La cheie', "price" : 109800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2de138a2e743e8b46a5_48%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage48, 'price': 0, 'included': true, 'name': "Sistem Ventilație Zehnder"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 0, 'included': true, 'name': "Jaluzele Smart"}],
                        [{ 'slug' : "solar-kit", 'image': solarImage, 'price': 11800, 'included': false, 'name': "Kit Solar - Prosumator"}] ]
                }
            ],
            "floorplan" : [
                { slug: "floorplan-a", image: "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c525733fc3797a1ea68b6_48m2%20Floorplan%20A.png", price: 0, name: "Plan A · 1 Dormitor", title: "48m² Plan A", rooms: [{ name: "Living + Bucătărie", size: "19.54m²" }, { name: "Dormitor", size: "11.43m²" }, { name: "Baie", size: "4.23m²" }], dimensions: { exterior: { L: "12.59m", W: "3.84m", H: "3.30m" }, interior: { L: "11.83m", W: "3.08m", H: "2.50m" } }, totalExterior: "48.35m²", totalInterior: "35.20m²" },
                { slug: "floorplan-b", image: "https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/689c514f671a54486d036b53_48m2%20Floorplan%20B.png", price: 0, name: "Plan B · 2 Dormitoare", title: "48m² Plan B", rooms: [{ name: "Hol", size: "4.23m²" }, { name: "Dormitor 1", size: "11.43m²" }, { name: "Baie 1", size: "4.23m²" }, { name: "Dormitor 2", size: "11.37m²" }, { name: "Baie 2", size: "3.44m²" }], dimensions: { exterior: { L: "12.59m", W: "3.84m", H: "3.30m" }, interior: { L: "11.83m", W: "3.08m", H: "2.50m" } }, totalExterior: "48.35m²", totalInterior: "34.70m²" }
            ]
        },
        'serenity-95' : {
            ...
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semifinisat', "price" : 109800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2de42d32a56c177baee_95%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 9800, 'included': false, 'name': "Sistem Ventilație Zehnder"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 7000, 'included': false, 'name': "Jaluzele Smart"}],
                        [{ 'slug' : "solar-kit", 'image': solarImage, 'price': 14800, 'included': false, 'name': "Kit Solar - Prosumator"}] ]
                },
            ...
            "options" : [
                { 'slug' : 'semi-finished', 'name' : 'Semifinisat', "price" : 159800,
                    ...
                    'upgrades' : [
                        ...
                        [ { 'slug' : "facade-yakisugi", 'image': yakisugiImageUrl, 'icon' : yakisugiIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Yakisugi"},
                            { 'slug' : "facade-lunawood", 'image': 'https://cdn.prod.website-files.com/6801f60a2febd7da21a30b43/692ef2d4db512d9db681f6e6_142%20EXT%20LUNA.avif', 'icon' : lunawoodIconUrl, 'price': 0, 'included': true, 'name': "Fațadă exterioară Lunawood"} ],
                        [{ 'slug' : "ventilation-system", 'image': ventilationImage, 'price': 9800, 'included': false, 'name': "Sistem Ventilație Zehnder"}],
                        [{ 'slug' : "blinds", 'image': blindsImage, 'price': 9000, 'included': false, 'name': "Jaluzele Smart"}],
                        [{ 'slug' : "solar-kit", 'image': solarImage, 'price': 16800, 'included': false, 'name': "Kit Solar - Prosumator"}] ]
                },
        ...
        if (scrollPercent >= 70) {
            ...
            if (!reservationLink) {
                if (buttonRow) {
                    ...
                    reservationLink.textContent = 'Sau pre-rezervă acum în avans.';
    ...
    function updateModelDescription() {
        ...
        const modelDescriptions = {
            'sanctuary': '142m² · Passivhaus · Fabricat în RO 🇷🇴',
            'serenity': '95m² · Passivhaus · Fabricat în RO 🇷🇴',
            'wanderlust': '48m² · Passivhaus · Fabricat în RO 🇷🇴',
            'nest': '24m² · Passivhaus · Fabricat în RO 🇷🇴'
        };
...
function sumCheckedPrices() {
    ...
    const upgradeKeys = ['SQF_PARQUET', 'SQF_FACADE', 'SQF_VENTILATION', 'SQF_BLINDS', 'SQF_SOLAR'];
...
function generateSolarSpecsModalContent() {
    ...
    if (!specs) {
        return "<p>Specificațiile kitului solar nu sunt disponibile pentru acest model.</p>";
    }
    ...
    return `
        ...
        <table class="solar-specs-table">
            <tbody>
                <tr>
                    <td class="spec-label">Putere DC</td>
                ...
                <tr>
                    <td class="spec-label">Număr panouri</td>
                    <td class="spec-value">${specs.panelCount}</td>
                </tr>
                <tr>
                    <td class="spec-label">Suprafață min. acoperiș</td>
                    <td class="spec-value">~${specs.minRoofArea} m&sup2;</td>
                </tr>
                <tr>
                    <td class="spec-label">Invertor</td>
                    <td class="spec-value">Huawei ${specs.inverter}</td>
                </tr>
                <tr>
                    <td class="spec-label">Fază</td>
                    <td class="spec-value">${specs.phaseLabel}</td>
                </tr>
                <tr>
                    <td class="spec-label">Configurație stringuri</td>
